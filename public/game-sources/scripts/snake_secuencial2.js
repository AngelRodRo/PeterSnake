$(document).on('ready', function() {
	...
	function init()
	{
		...
		/*agregacion de imagenes y sonido*/
		...
		iBackground.src = 'assets/fondoSecuencial2.png';
	...
	setTimeout(paint,1000,"right");
	setTimeout(paint,2000,"right");
	setTimeout(paint,3000,"right");
